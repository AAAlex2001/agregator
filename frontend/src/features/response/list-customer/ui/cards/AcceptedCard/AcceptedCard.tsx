...
import { ProfileIcon, StarIcon, ChevronIcon } from "@/shared/ui/icons";
...
export const AcceptedCard = ({
  ...
  const isUpdating = isRejectLoading || isSelectLoading || isChatLoading;
    ...
    <article className={styles.card}>
      ...
      <div className={styles.actions}>
        <Button
          ...
          className={styles.rejectBtnFixed}
        >
          Отклонить
        </Button>
        <Button
