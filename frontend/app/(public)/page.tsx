...
export const metadata: Metadata = {
	...
	description:
		"Тендерная площадка экспертизы промышленной безопасности (ЭПБ) опасных производственных объектов. Аттестованные эксперты промышленной безопасности Ростехнадзора, обследование, диагностирование и экспертиза, прозрачный выбор исполнителя, отчёты в PDF.",
	keywords: [
		...
		"реестр экспертов промышленной безопасности",
		...
		"категории экспертов промышленной безопасности",
