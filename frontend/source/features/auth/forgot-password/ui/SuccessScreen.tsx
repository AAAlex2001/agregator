...
export function SuccessScreen() {
  return (
    <div className={s.container}>
      ...
      />
      <motion.svg width="50" height="50" viewBox="0 0 24 24" className={s.checkmark}
        initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.6, duration: 0.6 }}>
        <motion.path d="M5 13l4 4L19 7" stroke="#FF8A00" strokeWidth="3" fill="none"
      ...
      <motion.p className={s.text}
        initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 1.4, duration: 0.5 }}>
        Вы обновили пароль.<br />Через мгновение продолжите<br />вход с новым паролем
      </motion.p>
    </div>
  );
}
