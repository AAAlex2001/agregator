...
import { SURVEY_LIABILITY_LEVELS, type SurveyHolderProfile } from "../model/types";
import s from "../../shared/ui/fields.module.scss";

interface Props {
  value: SurveyHolderProfile;
  onChange: (value: SurveyHolderProfile) => void;
}

export function SurveyHolderProfileFields({ value, onChange }: Props) {
  return (
    <div className={s.form}>
      <label className={s.field}>
        <span className={s.label}>Наименование СРО изыскателей</span>
        <TextInput
      ...
      <div className={s.field}>
        <span className={s.label}>
          Право выполнения инженерных изысканий в отношении особо опасных, технически сложных и
      ...
      <div className={s.field}>
        <span className={s.label}>
          Право выполнения инженерных изысканий в отношении объектов использования атомной энергии
        </span>
        <YesNoField
      ...
      <div className={s.field}>
        ...
        <RadioGroup
          name="survey-liability-level"
          value={value.liability_level}
          options={[...SURVEY_LIABILITY_LEVELS]}
