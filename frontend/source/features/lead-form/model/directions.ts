export interface LeadDirection {
  ...
  /** Популярные виды работ направления — те же, что в форме создания заказа. */
  kinds: string[];
}
...
export const LEAD_DIRECTIONS: LeadDirection[] = [
  {
    ...
    video: "/landing/expertise/lead.webm",
  ...
  },
  {
    ...
    kinds: [
      "Обязательный аудит СУПБ",
      "Оценка добросовестности",
      "Разработка положения о СУПБ",
      "Подготовка к проверке РТН",
  ...
  },
  {
    ...
    kinds: [
      ...
      "Магнитопорошковый и капиллярный",
  ...
  },
  {
    ...
    kinds: [
      "Инженерно-геологические (ИГИ)",
      "Инженерно-геодезические (ИГДИ)",
      "Инженерно-экологические (ИЭИ)",
      "Гидрометеорологические (ИГМИ)",
  ...
  },
  {
    ...
    kinds: [
      ...
      "Проект НДС",
      "Проект СЗЗ",
      "Программа и отчёт ПЭК",
      "Паспорта отходов",
      "Отчётность 2-ТП, 4-ОС",
      "Постановка на учёт НВОС",
    ],
  },
  {
    value: "RESEARCH",
