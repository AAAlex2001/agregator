...
interface ZepbRegistryWidgetProps {
  homeHref?: string;
}

export function ZepbRegistryWidget({ homeHref = "/" }: ZepbRegistryWidgetProps) {
  return (
    <div className={s.wrapper}>
      <Breadcrumbs items={[{ label: "Главная", href: homeHref }, { label: "Реестр заключений ЭПБ" }]} />
