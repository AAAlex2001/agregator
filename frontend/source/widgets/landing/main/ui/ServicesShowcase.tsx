...
const ServicesShowcase = ({ buttonText, basePath = "" }: ServicesShowcaseProps) => {
  ...
  return (
    <ServicesAccordion
      ...
      renderActions={(item) => {
        ...
        return item.href ? (
          <Button href={buildHref(item.href)} variant="primary" fullWidth showArrow className={s.button}>
            {buttonText}
          </Button>
        ) : (
