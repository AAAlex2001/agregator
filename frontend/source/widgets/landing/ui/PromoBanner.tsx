...
const PromoBanner = () => (
  <div className={s.banner}>
    <div className={`${s.half} ${s.tg}`}>
      <Image className={s.img} src="/promo/tg-bot.webp" width={1200} height={473} alt="" priority />
    ...
    <div className={`${s.half} ${s.app}`}>
      <Image className={s.img} src="/promo/app.webp" width={1200} height={473} alt="" priority />
      <span className={s.text}>
