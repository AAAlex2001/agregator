"""Аккаунт: вход в систему и данные, общие для всех ролей."""
...
class Account(Base):
    """Учётная запись: одна на пару email+роль. Ролевые данные — в profile."""
    ...
    license_holder_profile: Mapped["LicenseHolder | None"] = relationship(
        back_populates="account",
        cascade="all, delete-orphan",
        passive_deletes=True,
        uselist=False,
