...
class LandingHero(Base):
    "Hero-блок главного экрана лендинга."
...
class LandingStep(Base):
    "Шаг блока 'Как это работает' или 'Ключевые преимущества'."
...
class LandingPricingContent(Base):
    "Контент блока тарифов на лендинге."
