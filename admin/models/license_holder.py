...
class LicenseHolder(Base):
    "Ролевой профиль держателя разрешительных документов: лицензии, условия аренды, уведомления."
    ...
    account: Mapped["Account"] = relationship(back_populates="license_holder_profile", lazy="joined")

    def __str__(self) -> str:
        return f"Держатель документов: {self.account}"
