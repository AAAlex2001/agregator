...
class User(Base):
    ...
    notify_order_types: Mapped[list[Any] | None] = mapped_column(JSONB, nullable=True)
    ...
    license_areas: Mapped[list[Any] | None] = mapped_column(JSONB, nullable=True)
    ...
    password_reset_codes: Mapped[list["PasswordResetCode"]] = relationship(back_populates="user", passive_deletes=True)
    ...
    subscriptions: Mapped[list["UserSubscription"]] = relationship(back_populates="user", passive_deletes=True)
    ...
    support_tickets: Mapped[list["SupportTicket"]] = relationship(back_populates="user", cascade="all, delete-orphan", passive_deletes=True)
