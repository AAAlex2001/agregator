...
class Customer(Base):
    "Ролевой профиль заказчика: уведомления по событиям, адресованным заказчику."
    ...
    account: Mapped["Account"] = relationship(back_populates="customer_profile", lazy="joined")

    def __str__(self) -> str:
        return f"Заказчик: {self.account}"
